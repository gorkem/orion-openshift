...
public class OpenshiftCore implements BundleActivator {

	public static String BUNDLE_ID = "org.jboss.orion.openshift.server.core";
	private static BundleContext context;
	private static OpenshiftCore singleton;
	private ServiceTracker<FrameworkLog, FrameworkLog> logTracker;
	
	public static OpenshiftCore getDefault() {
		return singleton;
	}

	private static FrameworkLog getFrameworkLog() {
		//protect against concurrent shutdown
		OpenshiftCore a = singleton;
		if (a == null)
			return null;
	...
	public static void log(IStatus status) {
		FrameworkLog log = OpenshiftCore.getFrameworkLog();
		if (log != null) {
	...
	public void start(BundleContext bundleContext) throws Exception {
		singleton = this;
		OpenshiftCore.context = bundleContext;
	}
